    ...
    (() => {
        ...
        function moveSlider() {
            ...
            $(".owl-carousel").owlCarousel({
                ...
                navText: [ "<span class='nav-button owl-prev'>‹</span>", "<span class='nav-button owl-next'>›</span>" ],
        ...
        const menu = document.querySelector(".menu"), burgerBtn = document.querySelector(".burger-btn"), body = document.querySelector("body");
        function openBurgerMenu() {
            burgerBtn.addEventListener("click", (e => {
                ...
                if (!menu.classList.contains("active-menu")) body.style.overflow = "visible";
            }));
            let checkWidth = () => {
        ...
        const header = document.querySelector(".header__nav"), headerfix_menu = document.querySelector(".menu");
        let scrollPrev = 0;
        function fixedHeader() {
            if (window.innerWidth <= 993) {
                let scrolled = window.scrollY;
                if (scrolled > 50 && scrolled > scrollPrev && !headerfix_menu.classList.contains("active-menu")) header.classList.add("out"); else header.classList.remove("out");
                scrollPrev = scrolled;
            }
        }
        isWebp();
